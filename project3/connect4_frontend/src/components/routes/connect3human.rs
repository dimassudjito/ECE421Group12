...
#[function_component(Connect3HumanPage)]
pub fn connect3_human_page() -> Html {
    ...
    let reset_board = Callback::from(move |_| {
        let new_board = BoardGame::connect3(6, 7);
        cloned_con3.set(new_board);
    ...
    html! {
        <div>
            ...
            if *start {
                ...
                <table>
                    { for con3.board.container.iter().map(|inner_vec| {
                        html! {
                            <tr>
