    ...
    pub fn get_height(&self) -> i32 {
        ...
        match self {
            RedBlackTree::Node {
                ...
                return max(
                    left_child.borrow().get_height(),
                    right_child.borrow().get_height(),
                ) + 1;
            }
            RedBlackTree::Empty => {
                return 1;
        ...
        */
        ...
        for layer in 0..(self.get_height() - 1) {
            ...
            print!(
                "{}",
                " ".repeat(
                    (3 * two.pow((self.get_height() - 3 - layer + 1).try_into().unwrap()) - 2)
                        .try_into()
                        .unwrap()
                )
            );
            for elem in two.pow(layer as u32)..two.pow(layer as u32 + 1) {
                ...
                print!(
                    "{}",
                    " ".repeat(
                        (3 * two.pow((self.get_height() - 1 - layer).try_into().unwrap()) - 5)
                            .try_into()
                            .unwrap()
                    )
                );
            ...
            if layer != self.get_height() - 2 {
                ...
                print!(
                    "{}",
                    " ".repeat(
                        (3 * two.pow((self.get_height() - 3 - layer).try_into().unwrap()) + 1)
                            .try_into()
                            .unwrap()
                    )
                );
                for node in 0..two.pow(layer as u32) {
                    ...
                    if has_left_child {
                        ...
                        print!(
                            "{}",
                            "_".repeat(
                                (3 * two.pow((self.get_height() - 3 - layer).try_into().unwrap())
                                    - 2)
                                .try_into()
                                .unwrap()
                            )
                    ...
                    print!(
                        "{}",
                        " ".repeat(
                            (3 * two.pow((self.get_height() - 2 - layer).try_into().unwrap()) + 1)
                                .try_into()
                                .unwrap()
                        )
                    );
